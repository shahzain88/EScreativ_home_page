            ...
            <form role="form" id="projectInsertForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required name="client_name" class="form-control" id="client_name">
                  </div>

                  <div class="form-group">
                    <label for="start_date">Start Date <small class="start_date-error text-danger error"></small></label>
                    <input type="date" required name="start_date" class="form-control" id="start_date" >
                  </div>
                  <div class="form-group">
                    <label for="end_date">End Date <small class="end_date-error text-danger error"></small></label>
                    <input type="date" required name="end_date" class="form-control" id="end_date" >
                  </div>

                  <div class="form-group">
                    <label for="budget">Budget <small class="budget-error text-danger error"></small></label>
                    <input type="text" required name="budget" class="form-control" id="budget" placeholder="Enter budget">
                  </div>

                  <div class="form-group">
                    <label for="client_feedback">Client Feedback <small class="client_feedback-error text-danger error"></small></label>
                    <textarea name="client_feedback" required class="form-control summernote" id="client_feedback" cols="30" rows="5" placeholder="Enter client feedback"></textarea>
                  </div>

                  <div class="form-group">
                    <label for="description">Descripton <small class="description-error text-danger error"></small></label>
                    <div class="mb-3">
                        <textarea class="form-control summernote" required name="description" id="description"  placeholder="Place some text here"
