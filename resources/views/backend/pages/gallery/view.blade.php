                        ...
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a class="btn btn-info" href="{{route('gallery.create')}}">Create New</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    @if ($galleries)
                                        @foreach ($galleries as $key => $gallery)
                                            <tr>
                                                ...
                                                <td><img src="{{ asset('/') }}{{ $gallery->image }}" height="100"
                                                ...
                                                <td>
                                                    <a class="btn btn-info" href="{{ route('gallery.edit', $gallery->id) }}"><i class="fa fa-edit"></i> Edit</a>

                                                    <form style="display: inline-block" class="deleteGalleryForm"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                        <input type="hidden" value="{{ route('gallery.destroy', $gallery->id) }}" class="deleteUrl" name="url">
...
<script>
    $(document).on('submit', '.deleteGalleryForm', function(e) {
        e.preventDefault();
