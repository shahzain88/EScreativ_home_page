            ...
            <form role="form" id="galleryUpdateForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required name="caption" value="{{$gallery->caption}}" class="form-control" id="caption" placeholder="Enter title">
                  </div>

                  <div class="form-group">
                    <label for="inputImg">Image input <small class="subtitle-error text-danger error"></small></label>
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" id="inputImg" accept=".jpg, .jpeg, .png" name="image">
                        </div>
                    </div>
                    <img style="height: 100px; width:100px" src="{{ asset('/') }}{{ $gallery->image }}"
                        id="previewImg" alt="Preview">
                </div>

                <div class="form-group">
                    <input type="checkbox" @if ($gallery->status) checked @endif name="status" class="" id="status" value="1">
    ...
    <script>
        $(document).ready(function(){
            $("#galleryUpdateForm").on('submit', function(e){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('gallery.update', $gallery->id)}}",
