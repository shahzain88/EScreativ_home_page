        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
            <form role="form" id="productUpdateForm" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="construction_site" class="form-control" value="{{$product->construction_site}}" name="construction_site" placeholder="Enter Construction Site">
                    </div>

                  <div class="form-group">
                    <label for="service_name">Service Name <small class="service_name-error text-danger error"></small></label>
                    <input type="text" value="{{$product->service_name}}" required name="service_name" placeholder="Enter Service Name" class="form-control" id="service_name" >
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="mb-3">
                        <textarea class="form-control" id="service_description"  name="service_description"  placeholder="Service Description" rows="5" cols="30">{{$product->service_description}}</textarea>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" required name="product_name" value="{{$product->product_name}}" class="form-control" id="product_name" placeholder="Enter Product Name">
                  </div>
               

                  <div class="form-group">
                    <label for="product_price">Unit Price <small class="product_price-error text-danger error"></small></label>
                    <input type="text" required name="product_price" value="{{$product->product_price}}" class="form-control" id="product_price">
                  </div>

                  <div class="form-group">
                    <label for="product_details">Products Description <small class="product_details-error text-danger error"></small></label>
                    <textarea name="product_details" required class="form-control" id="product_details" cols="30" rows="5" placeholder="Enter Product Description">{{$product->product_details}}</textarea>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputFile">Image input <small class="product_image-error text-danger error"></small></label>
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" id="inputImg" accept=".jpg, .jpeg, .png" name="product_image">
                        </div>
                    </div>
                    <img style="height: 100px; width:100px" src="{{ asset('/') }}{{ $product->product_image }}"
                        id="previewImg" alt="Preview">
                </div>

                <div class="form-group">
                    <input type="checkbox" @if ($product->status) checked @endif name="status"
