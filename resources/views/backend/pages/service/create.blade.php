                        ...
                        <form role="form" id="serviceInsertForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="info" class="form-control" id="info" placeholder="Enter info">
                                </div>

                                <div class="form-group">
                                    <label for="unit_price">Unit Price</label>
                                    <input type="text" required name="unit_price" class="form-control" id="unit_price" placeholder="Enter unit price">
                                </div>
