                        ...
                        <form id="sliderUpdateForm" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="title" value="{{ $slider->title }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <img style="height: 100px; width:100px" src="{{ asset('/') }}{{ $slider->image }}"
                                        id="previewImg" alt="Preview">
                                </div>

                                <div class="form-group">
                                    <input type="checkbox" @if ($slider->status) checked @endif name="status" class="" id="status" value="1">
