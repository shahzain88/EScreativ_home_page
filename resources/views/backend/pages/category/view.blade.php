                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-md-6 text-right">
                                    <a class="btn btn-info" href="{{ route('category.create') }}">Create New</a>
                                </div>
                            </div>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            ...
                            <div class="alert alert-success alert-dismissible d-none">
                                ...
                                <small class="alert-message"><i class="fa fa-spinner fa-spin"></i> Redirecting to listing
                                    page...</small>
                            </div>
                                        ...
                                        @foreach ($categories as $key => $category)
                                            <tr>
                                                ...
                                                <td>
                                                    @if (isset($category->image))
                                                        <img style="height: 100px; width:100px"
                                                            ...
                                                            id="why_best_img_preview" alt="Preview">
                                                    @else
                                                        <img style="height: 100px; width:100px"
                                                            src="{{ asset('public/no_image_found.jpg') }}" id="previewImg"
                                                            alt="Preview">
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <form style="display: inline-block" class="deleteCategoryForm"
                                                        method="POST">
                                                        @method('DELETE')
                                                        @csrf
                                                        <input type="hidden" class="deleteId" name="id"
                                                            value="{{ $category->id }}">
                                                        <input type="hidden" class="deleteUrl" name="url"
                                                            value="{{ route('category.destroy', $category->id) }}">
