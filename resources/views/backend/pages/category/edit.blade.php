            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="categoryUpdateForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required name="name" value="{{$category->name}}" class="form-control" id="name"
                                        placeholder="Enter Name">
                                </div>

                                <div class="form-group">
                                    <label for="parent_id">Parent Category <small class="parent_id-error text-danger error"></small></label>
                                    <div class="mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    @if (isset($category->image))
                                        <img style="height: 100px; width:100px" src="{{asset('/')}}{{$category->image}}" id="previewImg" alt="Preview">
                                    @else
                                ...
                                <div class="form-group">
                                    <input type="checkbox" @if ($category->status) checked @endif  name="status" class="" id="status" value="1">
