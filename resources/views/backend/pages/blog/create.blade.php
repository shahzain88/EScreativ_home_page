            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="blogInsertForm" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="mb-3">
                                        <textarea class="form-control summernote" id="description" required name="description" placeholder="Place some text here"
...
@section('script')
    <script>
        $(document).ready(function() {
            $("#blogInsertForm").on('submit', function(e) {
                e.preventDefault();
                let thisForm = $(this);
                $.ajax({
                    type: "POST",
